    ...
    return <div>
        ...
        <div className="flex justify-center pt-2">
            <div className="text-xl font-bold font-normal text-center pt-8 max-w-2xl">
                AI gives you automation superpowers, and Webhook-X puts them to work. Pairing AI and Webhook-X helps you turn ideas into workflows and bots that work for you.
            </div>
        </div>
